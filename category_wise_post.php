...
<head>
    ...
    <title>Tsion Academy | Notice </title>
</head>
<body class="body_col">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand custom_font" href="landing_page.php">Tsion Academy</a>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link active custom_font" aria-current="page" href="landing_page.php">Home</a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <div class="col3">
        ...
        // Define the $category_of_post variable based on the 'cat_id' parameter in the URL
        if (isset($_GET['cat_id'])) {
            $category_of_post = $_GET['cat_id'];
            // You should validate and sanitize the $category_of_post variable here.
        } else {
            // Handle the case where 'cat_id' is not provided in the URL.
            // For example, you can set a default category or display an error message.
            // $category_of_post = 1; // Default category ID
            // or
            // die("Category ID is not provided");
        }
        
        // Query to select recent posts based on the category
        $query1 = "SELECT * FROM post WHERE category = '{$category_of_post}' ORDER BY post_id DESC LIMIT 0,5";
        
        $result1 = mysqli_query($connection,$query1) or die("Can't Query in Recent");
        $count1 = mysqli_num_rows($result1);
        if($count1 > 0){
    ...
    <footer class="bg-dark">
        <p class="text-white text-center">All rights reserved by Tsion Academy</p>
    </footer>
