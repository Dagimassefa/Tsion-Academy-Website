...
<div class="container">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="post.php">Post News / Notice</a>
                    </li>
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" autocomplete="off" class="container">
        ...
        <div class="mb-3 position-relative">
            ...
            <input name="username" type="text" class="form-control" placeholder="Enter Phone Number" id="exampleInputEmail1" aria-describedby="emailHelp" required>
        </div>
        <div class="mb-3 position-relative">
            <label for="exampleInputPassword1" class="form-label">Password</label>
            <input name="password" type="password" class="form-control" id="exampleInputPassword1" required>
            <!-- Add the show/hide password text link -->
            <a href="#" class="password-toggle" onclick="togglePasswordVisibility(this); return false;">Show</a>
        </div>
        <div class="mb-3">
