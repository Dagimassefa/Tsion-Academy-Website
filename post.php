...
<head>
    ...
    <title>Tsion Academy | Post Notice </title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                    <div class="container">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Post News / Notice </a>
                            </li>
                    ...
                    <a href="add_post.php?error=<?php echo '101' ?>" type="button" class="btn btn-primary">Add Notice</a>
